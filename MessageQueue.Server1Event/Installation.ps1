...
New-Service -Name MessageQueue_Server1Event -BinaryPathName $exePath\MyProject.exe -Credential $domainAndUser -Description "Hosting App .NET Core as a windows service" -DisplayName "Host Service MessageQueue_Server1Event" -StartupType Automatic
