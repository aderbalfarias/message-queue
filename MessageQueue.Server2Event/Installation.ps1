...
New-Service -Name MessageQueue_Server2Event -BinaryPathName $exePath\MyProject.exe -Credential $domainAndUser -Description "Hosting App .NET Core as a windows service" -DisplayName "Host Service MessageQueue_Server2Event" -StartupType Automatic
