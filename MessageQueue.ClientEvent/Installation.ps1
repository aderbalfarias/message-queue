...
New-Service -Name MessageQueue_ClientEvent -BinaryPathName $exePath\MyProject.exe -Credential $domainAndUser -Description "Hosting App .NET Core as a windows service" -DisplayName "Host Service MessageQueue_ClientEvent" -StartupType Automatic
